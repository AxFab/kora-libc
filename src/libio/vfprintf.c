...
unsigned __long __strtox(const char *, char **, int, char *);
...
extern const char *__utoa_digits;
extern const char *__utoa_digitsX;
                                        ...
                                        va_list *ap)
{
    ...
    if (*str == '*') {
        ...
        sb->field_ = (int)__strtox(str, (char **)&str, 10, &sign);
    ...
    if (str[0] == '.' && str[1] == '*') {
        ...
        str++;
        sb->precis_ = (int)__strtox(str, (char **)&str, 10, &sign);
    } else
        sb->precis_ = -1;
...
int _PRT(vfprintf)(FILE *fp, const char *str, va_list ap)
{
    ...
    while (*str) {
        ...
        case 'p':
            ...
            lg -= 2;
            _utoa(arg.i, tmp, 16, __utoa_digits);
            break;
        ...
        case 'X':
            ...
            if (str[-1] & 32)
                ...
                _utoa(arg.i, tmp, 16, __utoa_digitsX);
            break;

        case 'o':
            _utoa(arg.i, tmp, 8, __utoa_digits);
            break;

        case 'u':
            _utoa(arg.i, tmp, 10, __utoa_digits);
            break;
        ...
        case 'i':
            ...
            if (arg.s >= 0)
                _utoa(arg.s, tmp, 10, __utoa_digits);
